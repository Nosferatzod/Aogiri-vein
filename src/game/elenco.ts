...
export const ELENCO: Personagem[] = [
    ...
    },
    {
        ...
        golpes: [
            ...
            { anim: 'e1400', nome: 'Reshiram Beam',   comando: '26C', rc: 34, poder: 0, dano: 38, alcance: 280, forma: 'projetil', golpes: 1, drena: 0,
              dica: 'Feixe reto e longo. Atravessa e limpa o corredor.' },
    ...
    },
    {
        ...
        golpes: [
            ...
            { anim: 'e550',  nome: 'Narukami — raio', comando: '236B', rc: 32, poder: 0, dano: 36, alcance: 240, forma: 'projetil', golpes: 1, drena: 0,
              dica: '鳴神-雷. Descarga reta que atravessa o corredor.' },
            { anim: 'e560',  nome: 'Narukami — arco', comando: '236C', rc: 28, poder: 0, dano: 16, alcance: 126, forma: 'radial',   golpes: 4, drena: 0,
              dica: 'Arco elétrico em volta dele.' },
            { anim: 'e3050', nome: 'Corte — vão',     comando: '236236A', rc: 0, poder: 1000, dano: 40, alcance: 152, forma: 'avanco', golpes: 4, drena: 0,
              dica: '斬-空隙桜. Uma barra. Atravessa o cômodo cortando.' },
            { anim: 'e3100', nome: 'Corte — flor',    comando: '214214A', rc: 0, poder: 1000, dano: 46, alcance: 160, forma: 'radial', golpes: 4, drena: 0,
              dica: '斬-華. Uma barra.' },
            { anim: 'e3150', nome: 'Árvore prateada', comando: '22B',  rc: 0, poder: 2000, dano: 58, alcance: 175, forma: 'radial', golpes: 4, drena: 0,
              dica: '銀樹. Duas barras.' },
            { anim: 'e114514', nome: 'Ceifador Branco', comando: '22C', rc: 0, poder: 3000, dano: 90, alcance: 210, forma: 'radial', golpes: 5, drena: 0,
